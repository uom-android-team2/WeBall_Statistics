...
public class Config {
    ...
    public static final String API_URL = "http://" + IP + "/backend/API/";
    ...
    public static final String PLAYER_IMAGES_RESOURCES = "http://" + IP + "/backend/resources/player_images/";
    public static final String TEAM_IMAGES_RESOURCES = "http://" + IP + "/backend/resources/team_images/";
